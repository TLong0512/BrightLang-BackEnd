...
public static class Seed
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await context.ExamTypes.AddRangeAsync(
            new ExamType
            {
                Id = guids[0],
                Name = "TOPIK I",
        ...
        await context.Levels.AddRangeAsync(
            new Level { Id = guids[2], Name = "Cấp 1", ExamTypeId = guids[0] },
            new Level { Id = guids[3], Name = "Cấp 2", ExamTypeId = guids[0] },
            new Level { Id = guids[4], Name = "Cấp 3", ExamTypeId = guids[1] },
            new Level { Id = guids[5], Name = "Cấp 4", ExamTypeId = guids[1] },
            new Level { Id = guids[6], Name = "Cấp 5", ExamTypeId = guids[1] },
            new Level { Id = guids[7], Name = "Cấp 6", ExamTypeId = guids[1] }
        );

        //seed data for skill
        await context.Skills.AddRangeAsync(
            new Skill { Id = guids[8], SkillName = "Nghe" },
            new Skill { Id = guids[9], SkillName = "Đọc" },
            new Skill { Id = guids[10], SkillName = "Viết" }
        );

        //seed data for level - skill
        await context.SkillLevels.AddRangeAsync(
            new SkillLevel
            {
        ...
        //level 1 
        //listening ranges
        await context.Ranges.AddRangeAsync(
            new Range
            {
                Id = guids[27],
